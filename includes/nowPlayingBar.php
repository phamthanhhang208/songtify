...
<script>
	...
	function playSong(){
		...
		//$(".trackCount .play").hide();
		//$(".trackCount .pause").show();
		audioElement.play();
	}

	function pauseSong(){
		//$(".trackCount .play").show();
		//$(".trackCount .pause").hide();
...
<div id="nowPlayingBarContainer">
	<div id="nowPlayingBar">
		...
		<div id="nowPlayingRight">
			<div class="volumeBar">
				<button class="controlButton Volume" title="Volume" style="margin-left: 200px;" onclick="setMuted()">
